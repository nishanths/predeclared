// Command predeclared prints the names and locations of declarations in
// the given packages that have the same name as one of Go's
// predeclared identifiers (eg., int, string, delete, copy, append).
//
// Usage
//
...
// identifier.)
//
// The '-ignore' string flag can be used to specify predeclared identifiers to not
